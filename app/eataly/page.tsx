...
const features = [
  {
    id: "pizza",
    tag: "Pizza au four à bois",
    title: "Nos pizzas artisanales",
    body: "Nos pizzas artisanales sont préparées avec une pâte fraîche, une cuisson authentique au four à bois et des ingrédients soigneusement sélectionnés. La signature du chef ? Des saveurs généreuses, une pâte légère et ce goût italien unique qui fait toute la différence à chaque bouchée.",
    image: "/eataly/feature-pizza.jpg",
    imageAlt: "Pizza au four à bois Garden Eataly",
    imageRight: false,
  },
  {
    id: "pasta",
    tag: "Pasta",
    title: "Des pâtes fraîches & savoureuses",
    body: "Des pâtes fraîches, des sauces riches en goût et des recettes inspirées de l'Italie traditionnelle. Chaque assiette est pensée pour offrir un parfait équilibre entre gourmandise, simplicité et authenticité.",
    image: "/eataly/feature-pasta.jpg",
    imageAlt: "Pasta Garden Eataly",
    imageRight: true,
  },
  {
    id: "dessert",
